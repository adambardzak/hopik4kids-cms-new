...
export function ModuleTabs({ role }: { role: Role }) {
  ...
  return (
    <div className="mb-5 hidden shrink-0 overflow-x-auto md:flex">
      <div className="inline-flex shrink-0 gap-1 rounded-lg border border-[var(--border)] bg-[var(--background)] p-1">
